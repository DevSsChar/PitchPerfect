    ...
    <div className={styles.container}>
      ...
      <section className={styles.heroSection}>
        <div className="max-w-4xl mx-auto text-center px-4">
          <h1 className="text-5xl font-bold text-blue-800 mb-6">How PitchPerfect Works</h1>
      ...
      <section className={styles.stepSection}>
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-2">How It Works</h2>
          ...
          <div className={styles.stepContainer}>
            ...
            <div className={styles.stepCard}>
              ...
              <h3 className="text-2xl font-bold text-blue-800 mb-3">Record Your Presentation</h3>
              ...
              <ul className="text-left space-y-2 w-full text-black">
            ...
            <div className={styles.stepCard}>
              ...
              <h3 className="text-2xl font-bold text-blue-800 mb-3">AI Analyzes Your Performance</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className={styles.stepCard}>
              ...
              <h3 className="text-2xl font-bold text-blue-800 mb-3">Get Personalized Coaching</h3>
              <p className="text-gray-600 mb-6">
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${styles.analysisSection}`}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-4">What Our AI Analyzes</h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          ...
          <div className={styles.metricsGrid}>
            ...
            <div className={styles.metricCard}>
              <div className={`${styles.metricIcon} bg-gradient-to-br from-teal-100 to-teal-50`}>
              ...
              <h3 className="text-xl font-semibold text-blue-800 mb-2">Speaking Pace</h3>
            ...
            {/* Metric 2 */}
            <div className={styles.metricCard}>
              <div className={`${styles.metricIcon} bg-gradient-to-br from-blue-100 to-blue-50`}>
              ...
              <h3 className="text-xl font-semibold text-blue-800 mb-2">Filler Words</h3>
              <p className="text-gray-600 text-sm">
            ...
            {/* Metric 3 */}
            <div className={styles.metricCard}>
              <div className={`${styles.metricIcon} bg-gradient-to-br from-purple-100 to-purple-50`}>
              ...
              <h3 className="text-xl font-semibold text-blue-800 mb-2">Vocal Confidence</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${styles.resultsSection}`}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-4">See Real Results</h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          ...
          <div className={styles.resultsCard}>
            <div className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                <div>
                  <h3 className="text-xl font-semibold text-blue-800 mb-6">Performance Summary</h3>
                  
                  <div className={styles.performanceMetrics}>
                    <div className={styles.metricRow}>
                      <span className="text-gray-700">Overall Score</span>
                      <span className="text-teal-500 font-semibold text-lg">78%</span>
                    </div>
                    <div className={styles.metricRow}>
                      <span className="text-gray-700">Speaking Pace</span>
                      <span className="text-orange-500 font-semibold">160 WPM</span>
                    </div>
                    <div className={styles.metricRow}>
                      <span className="text-gray-700">Filler Density</span>
                      <span className="text-teal-500 font-semibold">3.2%</span>
                    </div>
                    <div className={styles.metricRow}>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-blue-800 mb-6">Top Coaching Tip</h3>
                  ...
                  <div className={styles.coachingTip}>
                    ...
                    <button className="bg-teal-500 text-white px-5 py-2 rounded-md text-sm hover:bg-teal-600 transition-colors duration-300">
                      Apply This Tip
                    </button>
                  </div>
                </div>
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${styles.ctaSection}`}>
        <div className="max-w-5xl mx-auto">
          <div className={styles.cta}>
            <h2 className="text-3xl font-bold mb-6 text-blue-800">Ready to Transform Your Presentations?</h2>
