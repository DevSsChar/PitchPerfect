...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[85vh] bg-gradient-to-b from-white to-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center font-inter">
      <div className="max-w-md w-full space-y-8">
        {/* Header */}
        <div className="text-center">
          <h1 className="text-3xl font-bold text-[#1e439c] font-montserrat">Welcome to PitchPerfect</h1>
          <p className="mt-2 text-gray-600">Sign in to continue your journey to better presentations</p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="relative">
            <button
              ...
              className="group w-full flex justify-center py-4 px-6 border border-gray-200 rounded-xl shadow-sm bg-white text-lg font-medium text-gray-800 hover:bg-gray-50 hover:shadow-md transition-all duration-200 relative overflow-hidden"
            >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-gradient-to-b from-white to-gray-50 text-gray-500">or</span>
          </div>
        </div>

        {/* Back to Home */}
        <div className="text-center">
          <Link href="/" className="text-[#1e439c] hover:underline transition-colors font-medium">
            Return to Homepage
          </Link>
        </div>
